...
import { Send } from "src/application/room/Send.js";
import { SendController } from "./controller/sendController.js";
...
// findById 
const findRoomUseCase = new FindRoomById(roomRepository, jwtService, mqttService, sender)
...
// Send
const sendUseCase = new Send(roomRepository, sender)
export const sendController = new SendController(sendUseCase)